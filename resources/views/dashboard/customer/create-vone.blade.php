...
@section('db-page-title', 'Tambah Customer v1')
@section('icon-page')
...
@section('breadcrumb')
    ...
    <x-ui.breadcrumb-item>Tambah Customer v1</x-ui.breadcrumb-item>
@endsection
    ...
    <div class="container-fluid mt-2" style="padding-left:0">
        <div class="card shadow-sm border-0 mb-4 rounded-4">
            ...
            <div class="card-body p-4">
                <form action="{{ route('store-v1-customer') }}" method="POST" enctype="multipart/form-data">
                    @csrf
