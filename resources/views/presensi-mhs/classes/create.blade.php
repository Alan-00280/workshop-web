...
@section('db-page-title', 'Tambah Kelas')
@section('icon-page')
        ...
        <div class="card-body p-4">
            <form action="{{ route('store-class') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Kelas IF301 - Paralel A" required>
                    @error('name')
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('schedule_start') is-invalid @enderror" id="schedule_start" name="schedule_start" value="{{ old('schedule_start', now()->format('Y-m-d\TH:i')) }}" required>
                    ...
                    <div class="col-md-6 form-group mb-4">
                        ...
                        <input type="datetime-local" class="form-control @error('schedule_end') is-invalid @enderror" id="schedule_end" name="schedule_end" value="{{ old('schedule_end', now()->addHours(2)->format('Y-m-d\TH:i')) }}" required>
                        @error('schedule_end')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
