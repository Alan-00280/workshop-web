...
<head>
    ...
    <style>
        html, body {
            ...
            background-color: #f8f9fa; /* bg-light matching landing */
            overflow-x: clip; /* Fix for position: sticky inside body */
        }
...
<body class="bg-light">
    ...
    <!-- NAV BAR -->
    <div class="pt-4 px-5 m-0 w-100 bg-white d-flex justify-content-between flex-wrap shadow-sm pb-3" style="position: sticky; top: 0; z-index: 1030;">
        <a href="/" class="text-decoration-none">
            <h3 class="fw-bold text-primary mb-4">Purpily Dessert & Bakery 🍰</h3>
        </a> 
        <div>
            <a class="btn btn-outline-primary {{ request()->is('products'.'*') ? 'active' : '' }} rounded-5 mx-1" href="{{ route('products-page') }}">
                Stores
                <i class="fa-solid fa-store"></i>
            </a>
            <a class="btn btn-outline-primary {{ request()->is('cart'.'*') ? 'active' : '' }} rounded-5 mx-1" href="{{ route('cart-show') }}">
                Keranjang
