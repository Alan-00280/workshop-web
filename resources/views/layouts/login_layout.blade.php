                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    {{-- <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black">Lwufy Alan</p>
                            </div>
                        </a>
                    ...
                    <li class="nav-item nav-logout d-none d-lg-block">
                        <a class="nav-link" href="/login">
                            Login <i class="fa-solid fa-right-to-bracket" style="margin: 5px"></i>
                        </a>
                    </li>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2026 <a
                                href="https://github.com/Alan-00280" target="_blank">xyzeerg</a>. All rights
                            reserved.</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made
                            with <i class="mdi mdi-heart text-danger"></i> by Alan</span>
                    </div>
                </footer>
                <!-- partial -->
