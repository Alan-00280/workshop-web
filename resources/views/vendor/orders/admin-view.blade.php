...
@section('db-page-title', 'Daftar Semua Pesanan')
@section('icon-page')
    <i class="fa-solid fa-clipboard-list"></i>
@endsection

@section('breadcrumb')
    <x-ui.breadcrumb-item>Semua Pesanan</x-ui.breadcrumb-item>
@endsection
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card border-0 shadow-sm bg-primary text-white rounded-3">
                    <div class="card-body">
                        <h6 class="mb-1 opacity-75">Total Pesanan Keseluruhan</h6>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        <h6 class="mb-1 text-muted">Total Pesanan Lunas</h6>
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-end">
                <div class="text-end">
                    <h5 class="fw-bold text-dark mb-0">Riwayat Pesanan Semua Vendor</h5>
                    <p class="text-muted small mb-0">Memantau transaksi di seluruh platform</p>
                </div>
            </div>
        </div>
                                    ...
                                    @forelse($details as $d)
                                        <tr>
                                            <td>
                                                ...
                                                @if(isset($d['nama_vendor']))
                                                    <div><span class="badge bg-light text-secondary border mt-1"><i class="fa-solid fa-store me-1"></i>{{ $d['nama_vendor'] }}</span></div>
                                                @endif
                                                @if(!empty($d['catatan']))
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#ordersTable').DataTable({
                responsive: true,
                language: {
                    // ID localization untuk Datatable
